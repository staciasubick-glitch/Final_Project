...
- GUI updates and color resets -Win detection
- Restarting the board

Key methods include: 
- find_valid_moves(row, col)
   - Returns a list of all legal moves for the piece at (row, col). Used for highlighting and multi-jump logic. 
- is_valid_move(old_row, old_col, new_row, new_col)
   - Returns True/False for a single move attempt. Used to validate drag-and-drop actions. 
